...
— ранговое усреднение пяти валидационных сидов против среднего по ним: 0.8894 → 0.8911
P@R70. Десять сидов вместо пяти берутся потому, что ответ считается один раз и
уменьшение дисперсии достаётся даром.
""")
